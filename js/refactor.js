...
(function () {
   ...
   // Put your answer below -------------------------
   // [c]: z then y
   //  setTimeout with cause the console.log when letter = y to be delayed; it will log after letter = z consold.log fires
   // -----------------------------------------------
   ...
   const spanishColor = function (color) {
      return colorKey[color];
   };

   // if else statements can be refactored with "?" & ":"
   // -----------------------------------------------
